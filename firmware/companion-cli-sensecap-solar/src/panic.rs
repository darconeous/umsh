//! Panic handler for the companion-cli-sensecap-solar bringup firmware.
//!
//! Identical in structure to the Wio Tracker / T-Echo panic handlers —
//! wires together the three BSP pieces that must be glued in a binary:
//!
