...
| Address in packets | 2-byte hint (S=0) or full 32-byte key (S=1) | 16-byte truncated SHA-256 hash ([`Reticulum.py:146`](https://github.com/markqvist/Reticulum/blob/1.1.4/RNS/Reticulum.py#L146), `TRUNCATED_HASHLENGTH = 128`) |
