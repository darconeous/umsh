...
//!
//! `umsh-display-sh1106` now carries the same driver generic over an
//! `embedded-hal-async` I²C, with the address discovered rather than
//! fixed. This copy stays until this board's next hardware pass makes
//! swapping it safe; the two are meant to converge on that crate.
//!
