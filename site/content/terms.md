+++
title = "Terms"
description = "The terms this website, the software, and the specification are offered under."
weight = 9
+++
...
UMSH is free and open source software, dual licensed under the
[Apache License 2.0](https://github.com/darconeous/umsh/blob/main/LICENSE-APACHE)
and the [MIT License](https://github.com/darconeous/umsh/blob/main/LICENSE-MIT),
at your option.
...
UMSH is a technology preview. The protocol is unfinished and changes without
regard for compatibility. Firmware may fail, messages may not arrive, and an
update may leave a radio needing to be reflashed before it works again.

**Do not rely on UMSH where a failure to communicate would be dangerous.** It
is not suitable for emergency communication, for medical or safety-critical
use, or as anyone's only way of calling for help. Carry something you trust
instead, and treat this as the interesting experiment it is.

## Radio regulations are your responsibility
...
The boards this site describes are made and sold by other companies. Links to
them are provided because they are useful, not as an endorsement, and no
affiliation or partnership is implied. Your purchase is with the vendor, on
...
Product and company names on this site belong to their respective owners and
are used to identify the hardware and software being discussed. Meshtastic,
...
These terms may change. The date at the top will change with them, and the
history is public in the project's git repository. Continuing to use the
software after a change means the new terms apply.
