+++
title = "Hardware"
description = "The boards that run UMSH today, the ones being worked on, and what each is good for."
...
The categories below are about what a board is *good for*, not about what
software it can run.
